...
// // change: 수정할 값
// public static void changing(Long[] result, int start, int end, int idx, Long
// change, int Node) {
// // 범위 밖에 있는경우
...
// public static Long findSum(Long[] result, int start, int end, int left, int
// right, int Node) {
// // 범위 밖에 있는 경우
...
// // start: 시작인덱스 , end: 끝 인덱스
// public static Long init(Long[] result, String[] arr, int start, int end, int
// Node) {
